...
namespace Tutorial.Tests.MyClassesUT
{
    ...
    public class CapValuationCalculatorUT
    {
        ...
        PriceBand midBand;
        PriceBand highBand;
        List<PriceBand> lowOnlyPriceBands;
        List<PriceBand> lowAndMidPriceBands;
        List<PriceBand> allBandsPriceBands;
        PriceRecord lowOnly;
        PriceRecord lowAndMid;
        PriceRecord allBands;
        CAPValuationCalculator capValuationCalculator;
        ...
        {
            decimal actual = this.capValuationCalculator.calculate(lowAndMid, 15);
        ...
        {
            decimal actual = this.capValuationCalculator.calculate(allBands, 15);
            decimal expected = new decimal(15000.0);
            Assert.AreEqual<decimal>(expected, actual, "The capValuationCalculator miscalculated the price");
        }
        ...
        {
            decimal actual = this.capValuationCalculator.calculate(allBands, 20);
        ...
        {
            decimal actual = this.capValuationCalculator.calculate(lowAndMid, 12);
        ...
        {
            decimal actual = this.capValuationCalculator.calculate(allBands, 18);
        ...
        {
            decimal actual = this.capValuationCalculator.calculate(allBands, 13);
        ...
        {
            decimal actual = Math.Round(this.capValuationCalculator.calculate(lowOnly, 20), 2);
        ...
        {
            decimal actual = Math.Round(this.capValuationCalculator.calculate(lowAndMid, 20), 2);
        ...
        {
            decimal actual = Math.Round(this.capValuationCalculator.calculate(lowOnly, 9), 2);
        ...
        {
            decimal actual = Math.Round(this.capValuationCalculator.calculate(lowOnly, 8), 2);
        ...
        {
            decimal actual = Math.Round(this.capValuationCalculator.calculate(allBands, 1000), 2);
        ...
        public void TestForNewCustomBands()
        {
            ...
            decimal actual = Math.Round(this.capValuationCalculator.calculate(customPR, 2), 2);
